...
updatecolors (const Arg *arg) {
    char colors[16][8];
    FILE *f = fopen("/home/quantumish/.cache/wal/colors", "r");
    for (int i = 0; i < 16; i++) {
        fgets(colors[i], 16, f); // Why 16? I have literally no clue but it doesn't work for 8
        colors[i][7] = '\0';
    }
    strcpy(normfgcolor, colors[15]);
    strcpy(normbgcolor, colors[0]);
    strcpy(normbordercolor, colors[8]);

    strcpy(selfgcolor, colors[15]);
    strcpy(selbgcolor, colors[2]);
    strcpy(selbordercolor, colors[15]);

    strcpy(titlenormfgcolor, colors[15]);
    strcpy(titlenormbgcolor, colors[0]);
    strcpy(titlenormbordercolor, colors[8]);
    
    strcpy(titleselfgcolor, colors[15]);
    strcpy(titleselbgcolor, colors[2]);
    strcpy(titleselbordercolor, colors[15]);

    strcpy(tagsnormfgcolor, colors[15]);
    strcpy(tagsnormbgcolor, colors[0]);
    strcpy(tagsnormbordercolor, colors[15]);

    strcpy(tagsselfgcolor, colors[15]);
    strcpy(tagsselbgcolor, colors[2]);
    strcpy(tagsselbordercolor, colors[15]);

    strcpy(hidfgcolor, colors[15]);
    strcpy(hidbgcolor, colors[2]);
    strcpy(hidbordercolor, colors[15]);

    strcpy(urgfgcolor, colors[15]);
    strcpy(urgbgcolor, colors[1]);
    strcpy(urgbordercolor, colors[1]);

    static char *colors2[][ColCount] = {
        /*                       fg                bg                border                float */
